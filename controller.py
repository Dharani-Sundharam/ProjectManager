...
def main():   
    ...
    # Import the tcl file
    root.tk.call("source", "C:/Users/admin/Desktop/Programming/Naadi app/NoGUI/forest-dark.tcl")
    

    # Set the theme with the theme_use method
    style.theme_use("forest-dark")
    
    button1 = Button(root, text="Create new user", command=create_user)
    button1.pack(pady=10)

    button2 = Button(root, text="Login to database", command=login)
